...
def main():
	...
	while True:
		powerran = (random.randint(11097,55997))
		bot1 = (random.randint(11005,65100))
		bot2 = (random.randint(666,2109))
		bot3 = (random.randint(1212,2109))
		sys.stdout.write("\x1b]2;[-] TransformerXBumblebee | Api Connected [999999] | Backup Server [999999] | Online User [999999] | Admin: [TransformerXBumblebee] | POWER : {}% [STABLE]\x07".format (powerran,bot1,bot2,bot3))
